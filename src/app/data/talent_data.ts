...
//
// Sorry, decided to add another one to see if I can PR 
// from the terminal properly this time
export type Talent = {
    category: string
    PreReq: string
    Tag: string
